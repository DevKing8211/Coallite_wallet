...
export class MyApp {
  ...
  acActive: object = {'background-color': '#3a86c7'};
  coActive: object = {};
  abActive: object = {};
  ...
  initializeApp() {
    this.platform.ready().then(() => {
      ...
      this.statusBar.backgroundColorByHexString('#F99D1C');
      this.headerColor.tint('#F99D1C');
      ...
      this.platform.registerBackButtonAction(() => {
        ...
        if (this.backButtonPressedOnceToExit) {
          ...
          this.nav.pop({}).then(() => {
            ...
            if (page == HomePage){
              this.acActive = {'background-color': '#3a86c7'};
              this.coActive = {};
              this.abActive = {};
            } else if (page == ContactsPage){
              this.acActive = {};
              this.coActive = {'background-color': '#3a86c7'};
              this.abActive = {};
            } else if (page == AboutPage){
              this.acActive = {};
              this.coActive = {};
              this.abActive = {'background-color': '#3a86c7'};
            }
          });
